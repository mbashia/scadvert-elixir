defmodule ScadvertWeb.Router do
  use ScadvertWeb, :router

  import ScadvertWeb.UserAuth
  ...
  scope "/", ScadvertWeb do
    ...
    post "/headers/search", HeaderController, :search
    ...
    post "/leaderships/search", LeadershipController, :search
  ...
  scope "/", ScadvertWeb do
    ...
    post "/code_informtation/", CodeInfoController, :create
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: ScadvertWeb.Telemetry
    end
  end
